...
def process_telemetry_timeseries(
    ...
    for index, curr in enumerate(raw_packets):
        ...
        # 3. Tariff & financial logic
        import_rate = get_import_rate(hour)
        cost_without_solar = room_load * import_rate
        actual_cost = (grid_import * import_rate) - (grid_export * FEED_IN_RATE)
        hourly_savings = cost_without_solar - actual_cost
